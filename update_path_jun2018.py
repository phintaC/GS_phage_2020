...
# Prompt for stuff
path_out = "/home/projects/cge/backup/fastq/cge_private/FOOD_seqdata/HiSeq/Metagenomics/Trimmed_data/"
...
with open(file_in, "r") as infile: 
	for line in infile:
		...
		trim_dir = path_out + "2019_Flowcell_1/" + r1_col.split("/")[-1].replace("_R1.fastq.gz", "_trim/")
		...
		# Writes to file; because some files are located in different directory with different structure
		with open(file_out, "a") as outfile:
			if r1_col.split("/")[11] == "2019_Flowcell_4":
				outfile.write(path_out + "2019_Flowcell_4/Trimmed/" + r1_trim + "\t" + 
					path_out + "2019_Flowcell_4/Trimmed/" + r2_trim + "\t" +
					path_out + "2019_Flowcell_4/Trimmed/" + r1_trim + "\n")
